...
const ThemeIcons = memo(function ThemeIcons() {
  return (
    <div className="inline-flex bg-[#fff] dark:bg-[#111] rounded-3xl shadow-sm p-7" role="group">
      <button
        id="light"
        aria-label="Switch to light theme"
        type="button"
        className=" px-4 py-4 text-sm mx-3 font-medium text-gray-900 bg-white border border-gray-200 rounded-2xl hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white active:bg-[#333]"
      >
        <svg
          height="16"
